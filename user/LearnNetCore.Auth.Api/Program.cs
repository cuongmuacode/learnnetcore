...
using LearnNetCore.Auth.Postgresql.Db;
...
namespace LearnNetCore.Auth.Api;
/// <summary>
/// 
/// </summary>
public class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddSwaggerGen(options =>
        {
            ...
            {
                Version = "v1",
                Title = "LearnNetCore Authentication API",
        ...
        builder.Services.AddLearnNetCoreAuthPostgresqlDbServices(configuration);
